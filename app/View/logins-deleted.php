							...
							<div class="card">
								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										...
										<tr>
											<td>
												<img src="Assets/img/avatars/<?php echo $r->username; ?>.jpg" width="48" height="48" class="rounded-circle me-2" alt="Avatar">
			...
			<input id="toastr-message" name="toastr-message" type="hidden" class="form-control" value="Login eliminado exitosamente!">

			<?php require_once 'View/includes/toastr-deleted.php'; ?>