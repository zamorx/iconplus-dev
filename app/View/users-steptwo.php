					...
					<div class="row">
						<div class="col-xxl-9">
							...
							<div class="card">
								...
								<div class="card-body">
									<form id="validation-form" action="?c=Users&a=SaveStepTwo" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="mb-3 col-md-6 error-placeholder">
												...
												<div class="input-group mb-3">
                                    				...
                                    				<?php foreach ($this->model->ListSteps() as $r) : ?>
											...
											<div class="mb-3 col-md-6 error-placeholder">
												...
												<div class="input-group mb-3">
													...
													<select name="billinguser" id="billinguser" value="<?php echo $alm->billinguser; ?>" class="form-control">
														<option value="1">Opción activada</option>
													</select>
												</div>
											</div>
