									...
									<tbody>
										...
										<tr>
											<td>
												...
												<?php $r->invoicedate = date('d-m-Y', strtotime($r->invoicedate)); ?>	
	...
	<input id="toastr-message" name="toastr-message" type="hidden" class="form-control" value="Factura eliminada exitosamente!">
