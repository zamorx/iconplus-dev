						...
						<div class="col-xxl-8">
							...
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Lista de herrameintas de soporte para Windows y macOS, Seleccione y haga clic en el botón de descarga para comenzar.</h6>
								</div>
