					...
					<div class="header">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Ofimática</li>
							</ol>
						</nav>
					</div>
					<div class="row">
						<div class="col-xxl-8">
							...
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Lista de programas de ofimática para Windows y macOS, Seleccione y haga clic en el botón de descarga para comenzar.</h6>
								</div>
						...
						<div class="col-xxl-4">
							<div class="card">
								<img class="card-img-top" src="Assets/img/photos/ofimatic.jpg" alt="Ofimatic">
								<div class="card-header">
									<h5 class="card-title mb-0">PDF creator softwares</h5>
								</div>
								<div class="card-body">
									<p class="card-text">PDF creator software allows users to generate, edit, and manage PDF documents efficiently for both personal and professional use.</p>
